class SimpleDiscussion::ForumThreadsController < SimpleDiscussion::ApplicationController
  ...
  def create
    ...
    if @forum_thread.save
      ...
      #Rails.logger.info "ForumThread save failed: #{@forum_thread.errors.full_messages.inspect}"
      redirect_to simple_discussion.new_forum_thread_path, alert: @forum_thread.errors.full_messages.to_sentence
    end
  end
